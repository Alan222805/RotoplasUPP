...
@section('links_diseño')
    <link rel="stylesheet" href="/css/estilos_admin/Estilos_productos_admin.css">
    ...
    <div class="botones-admin">
        <div class="contenedor-botones">
            <button class="btn-editar-contenido" id="editar-contenido">
                <a href="{{route('admin.modificar_productos', $producto)}}">
            ...
            <form action="{{route('admin.eliminar_productos', $producto)}}" method="POST">
                @csrf
                @method('DELETE')
